...
import PW from "../assets/Physicswallah.jpg"
...
const Cards = ({open}) => {
  return (
    <>
      <section className="bg-white  mx-[120px] mt-1 mb-0 dark:bg-dark lg:pb-20 lg:pt-[10px] flex justify-center items-center flex-col">
