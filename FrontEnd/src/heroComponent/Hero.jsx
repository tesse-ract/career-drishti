...
const Hero = () => {
  return (
    <>
      ...
      <div className="relative bg-white pb-[70px] pt-[50px] dark:bg-dark  px-[80px]">
          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-8 lg:w-5/12">
              ...
              className="hero-content">
                <div className="mb-5 text-xl font-semibold !leading-[1.208] text-black sm:text-[42px] lg:text-[40px] xl:text-2xl">
                Your Journey to Tomorrow Begins Here
                </div>
                <div className="mb-5 text-xl font-bold !leading-[1.208] text-primary sm:text-[42px] lg:text-[40px] xl:text-5xl">
