...
const Features = () => {
  return (
    <>
      <section className="bg-white pb-10 pt-5 dark:bg-dark lg:pb-20 lg:pt-[80px] px-[80px] ">
          ...
          <div className="mx-4 flex flex-wrap">
            <div className="w-full px-4">
              <div className="mx-auto mb-[0px] max-w-[510px] text-center lg:mb-20 w-full">
                ...
                <h2 className="mb-4 text-2xl font-bold text-black sm:text-4xl md:text-[40px] w-full text-nowrap">
        ...
        <div className="mb-10 w-full flex justify-center items-center flex-col">
          ...
          <div>
            <h3>
              <a
                href="/#"
                className="mb-4 flex text-xl font-semibold text-dark text-primary items-center justify-center text-center sm:text-2xl lg:text-xl xl:text-2xl"
              >
                {CardTitle}
              </a>
            </h3>
